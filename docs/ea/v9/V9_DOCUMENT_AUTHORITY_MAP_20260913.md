...
Current strategy-semantic authority remains:

`V9_PROTOTYPE_AUTHORITY_20260914.md`

Actual execution evidence remains:

`V9_MT5_ACTUAL_TICK_VALIDATION_20260914.md`

Money-management research remains:

`V9_MONEY_MANAGEMENT_STUDY_20260914.md`

Tick/ERA implementation precedence remains:
