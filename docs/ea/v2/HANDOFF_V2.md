> **V2 PAUSED / V3 ACTIVE ROUTING ??2026-08-24**  
> This V2 handoff is preserved as historical/current-control research evidence.  
> Active strategy discovery has moved to `docs/ea/v3/HANDOFF_V3.md`.  
> Do not rewrite or delete V2 results; resume V2 only by an explicit future decision.
