...
Current phase: `V8-A-N-SLOW / STRUCTURAL STATE FROZEN / PRACTICAL MOVEMENT CHARACTERIZATION NEXT`
...
Next phase is **practical movement/payoff characterization**, not TP optimization yet:

1. MFE while structure remains alive;
2. current directional displacement;
3. giveback from MFE;
4. first-hit time and target-distance distributions;
5. short-move vs large-winner continuation;
6. state conditioning: PRISTINE / DAMAGED / CLOSE_BROKEN;
7. joint structural-risk + progress state to distinguish smaller-profit vs runner candidates;
8. robustness across P0/P2, year, direction, regime;
9. only then preregister explicit entry/SL/TP economics;
10. keep 2021 locked.
...
1. `AGENTS_V8.md`
2. this file
3. `V8_A_N_SLOW_DYNAMIC_STRUCTURAL_STATE_RESEARCH_20260903.md`
