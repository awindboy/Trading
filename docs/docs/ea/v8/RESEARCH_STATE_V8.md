...
Status: `ACTIVE / STRUCTURAL STATE FROZEN / PRACTICAL MOVEMENT CHARACTERIZATION NEXT`
Date: `2026-09-03`
...
Begin practical movement/payoff characterization without optimizing TP/SL:
MFE, current displacement, giveback, hit-time distributions, large-winner continuation, and state-conditioned progress.

Only after robust descriptive/causal mapping:
preregister entry/SL/TP economics.
